...
print(r"Enter image path (\\ for windows)")
...
PATH_model = r"C:\Users\alexh\Projet_6\b7finetune.h5"
...
classes = ['n02085620-Chihuahua', 'n02085782-Japanese_spaniel', 'n02085936-Maltese_dog', 'n02086079-Pekinese',
           ...
           'n02110627-affenpinscher', 'n02110806-basenji', 'n02110958-pug', 'n02111129-Leonberg', 'n02111277-Newfoundland',
           'n02111500-Great_Pyrenees', 'n02111889-Samoyed', 'n02112018-Pomeranian', 'n02112137-chow', 'n02112350-keeshond',
...
print("Breed is : ",classes[np.argmax(predict_array)])